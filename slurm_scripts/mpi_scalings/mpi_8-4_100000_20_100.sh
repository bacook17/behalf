#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_8-4_100000_20_100 # Job Name
...
mpiexec -n $SLURM_NTASKS ../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 100000 --N-steps 20 --dt 0.01
RESULT=${PIPESTATUS[0]}
