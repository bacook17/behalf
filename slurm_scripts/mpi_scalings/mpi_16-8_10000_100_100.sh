#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_16-8_10000_100_100 # Job Name
#SBATCH -n 16 # Number of MPI tasks
#SBATCH -N 8 #ensure that all cores are on one machine
...
mpiexec -n $SLURM_NTASKS ../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 10000 --N-steps 100 --dt 0.01
RESULT=${PIPESTATUS[0]}
