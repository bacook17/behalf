#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_8_1000_100_100_0n # Job Name
...
mpiexec -n $SLURM_NTASKS ../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 1000 --N-steps 100 --dt 0.01 --THETA 0
RESULT=${PIPESTATUS[0]}
