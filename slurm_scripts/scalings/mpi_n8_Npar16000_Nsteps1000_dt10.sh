#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_8_16000_1000_10 # Job Name
...
mpiexec -n $SLURM_NTASKS ./../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 16000 --N-steps 1000 --dt 0.1
RESULT=${PIPESTATUS[0]}
