#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J serial_1000_1000_100 # Job Name
...
mpiexec -n $SLURM_NTASKS ./../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 1000 --N-steps 1000 --dt 0.01
RESULT=${PIPESTATUS[0]}
