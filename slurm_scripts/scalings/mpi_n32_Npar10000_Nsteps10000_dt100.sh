#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_32_10000_10000_100 # Job Name
...
mpiexec -n $SLURM_NTASKS ./../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 10000 --N-steps 10000 --dt 0.01
RESULT=${PIPESTATUS[0]}
