#!/bin/bash
#SBATCH -p hernquist
#SBATCH -J mpi_128_1000_1000_10 # Job Name
#SBATCH -n 128 # Number of MPI tasks
...
mpiexec -n $SLURM_NTASKS ./../../bin/run_behalf.py --run-name $SLURM_JOB_NAME --clobber --verbose --N-parts 1000 --N-steps 1000 --dt 0.1
RESULT=${PIPESTATUS[0]}
